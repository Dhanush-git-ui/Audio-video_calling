  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: MaterialApp.router(
        title: 'CallHealth | Everything about health',
        debugShowCheckedModeBanner: false,
        theme: ThemeData(
          useMaterial3: true,
          brightness: Brightness.dark,
          scaffoldBackgroundColor: const Color(0xFF0A1120),
          primaryColor: const Color(0xFF1554A6),
          canvasColor: const Color(0xFF111C33),
          cardColor: const Color(0xFF111C33),
          colorScheme: const ColorScheme.dark(
            primary: Color(0xFF1554A6),
            primaryContainer: Color(0xFF0D47A1),
            secondary: Color(0xFF78C02B),
            secondaryContainer: Color(0xFF558B2F),
            tertiary: Color(0xFF78C02B),
            surface: Color(0xFF111C33),
            surfaceContainerHighest: Color(0xFF162544),
